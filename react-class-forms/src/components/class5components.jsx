...
export default class Fiform extends Component{
    ...
    addUser = () => {
      axios({
        method:"post",
        url:"http://localhost:3002/allUsers4/",
    ...
    deleteUser = (usr,id) => {
      console.log(usr,id)
      var number=id+1;
      axios.delete("http://localhost:3002/allUsers4/"+number).then((res)=> this.componentDidMount())
    ...
    axios({
      method:"put",
      url:"http://localhost:3002/allUsers4/"+number,
    ...
    async componentDidMount  () {
      let response =await axios.get("http://localhost:3002/allUsers4/")
