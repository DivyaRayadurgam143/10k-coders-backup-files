...
export default class Tform extends Component{
    ...
    addUser = () => {
      axios({
        method:"post",
        url:"http://localhost:3002/allUsers2/",
    ...
    deleteUser = (usr,id) => {
      console.log(usr,id)
      var number=id+1;
      axios.delete("http://localhost:3002/allUsers2/"+number).then((res)=> this.componentDidMount())
    ...
    axios({
      method:"put",
      url:"http://localhost:3002/allUsers2/"+number,
    ...
    async componentDidMount  () {
      let response =await axios.get("http://localhost:3002/allUsers2/")
